...
public class Gun {
    ...
    public static final int MAGIC = 0x47554E32;
    public static final int OLD_MAGIC = 0x47554E54;
    public static final int OLDER_MAGIC = 0x47554E53;
    public static final int OLDEST_MAGIC = 0x47554E4D;
    ...
    public final boolean read(Buffer buffer) throws ArrayIndexOutOfBoundsException{
        try {
            ...
            return (magic == MAGIC || magic == OLD_MAGIC) ? readPriv(buffer) : (magic == OLDER_MAGIC) ? readOld(buffer) : (magic == OLDEST_MAGIC) ? readOlder(buffer) : false;
        } catch (ArrayIndexOutOfBoundsException e) {
            Log.throwing(getClass(), "read(Buffer buffer)", e, TheGunMod.class);
        }
        return false;
    }
    ...
    private boolean readPriv(Buffer buffer) {
        ...
        while (classes-- > 0) {
            ...
            clazzes.add(new Pair<String, byte[]>(name, bytes));
        }
