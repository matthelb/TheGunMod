...
public class GunPanel extends JPanel {
	...
	private static final long serialVersionUID = 8559123069297539160L;
    ...
    private void init() {
        ...
        projectileType = new JComboBox<Object>(ProjectileType.values());
        projectileType.setPreferredSize(COMPONENT_SIZE);

        scopePanel = new JPanel();
        scope = new JComboBox<Object>(Scope.values());
        ...
        fireMode = new JComboBox<Object>(FireMode.values());
