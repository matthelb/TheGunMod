...
public class MapGenStronghold extends MapGenStructure
{
    ...
    protected StructureStart getStructureStart(int i, int j)
    {
        ...
        for (structurestrongholdstart = new StructureStrongholdStart(worldObj, rand, i, j); structurestrongholdstart.getComponents().isEmpty() || ((ComponentStrongholdStairs2)structurestrongholdstart.getComponents().get(0)).field_40317_b == null; structurestrongholdstart = new StructureStrongholdStart(worldObj, rand, i, j)) { }
