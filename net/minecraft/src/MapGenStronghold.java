...
public class MapGenStronghold extends MapGenStructure
{
    ...
    public MapGenStronghold()
    {
        allowedBiomeGenBases = (new BiomeGenBase[]
                {
                    BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.taiga, BiomeGenBase.icePlains, BiomeGenBase.iceMountains, BiomeGenBase.field_46083_s, BiomeGenBase.field_46082_t, BiomeGenBase.field_46080_v
                });
    ...
    protected boolean canSpawnStructureAtCoords(int i, int j)
    {
        if (!ranBiomeCheck)
        {
            ...
            for (int i1 = 0; i1 < structureCoords.length; i1++)
            {
                ...
                ChunkPosition chunkposition = worldObj.getWorldChunkManager().func_35139_a((j1 << 4) + 8, (k1 << 4) + 8, 112, arraylist, random);
