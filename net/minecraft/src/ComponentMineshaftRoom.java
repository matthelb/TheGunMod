...
public class ComponentMineshaftRoom extends StructureComponent
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        for(Iterator iterator = field_35356_a.iterator(); iterator.hasNext(); fillWithBlocks(world, structureboundingbox, structureboundingbox1.minX, structureboundingbox1.maxY - 2, structureboundingbox1.minZ, structureboundingbox1.maxX, structureboundingbox1.maxY, structureboundingbox1.maxZ, 0, 0, false))
        {
