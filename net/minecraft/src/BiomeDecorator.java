...
public class BiomeDecorator
{
    ...
    protected void decorate()
    {
        ...
        for (int i = 0; i < sandPerChunk2; i++)
        {
            ...
            sandGen.generate(curWorldObj, randomGenerator, i1, curWorldObj.findTopSolidBlock(i1, k5), k5);
        }
        ...
        for (int j = 0; j < clayPerChunk; j++)
        {
            ...
            clayGen.generate(curWorldObj, randomGenerator, j1, curWorldObj.findTopSolidBlock(j1, l5), l5);
        }
        ...
        for (int k = 0; k < sandPerChunk; k++)
        {
            ...
            sandGen.generate(curWorldObj, randomGenerator, k1, curWorldObj.findTopSolidBlock(k1, i6), i6);
        }
        ...
        for (int l1 = 0; l1 < l; l1++)
        {
            ...
            WorldGenerator worldgenerator = biomeGen.getRandomWorldGenForTrees(randomGenerator);
        ...
        for (int j2 = 0; j2 < flowersPerChunk; j2++)
        {
            ...
            int i11 = randomGenerator.nextInt(curWorldObj.worldHeight);
            ...
            if (randomGenerator.nextInt(4) == 0)
            {
                ...
                int j11 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int k2 = 0; k2 < grassPerChunk; k2++)
        {
            ...
            int j15 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int l2 = 0; l2 < deadBushPerChunk; l2++)
        {
            ...
            int l11 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int i3 = 0; i3 < waterlilyPerChunk; i3++)
        {
            ...
            int l15;
            for (l15 = randomGenerator.nextInt(curWorldObj.worldHeight); l15 > 0 && curWorldObj.getBlockId(l7, l15 - 1, i12) == 0; l15--) { }
        ...
        for (int j3 = 0; j3 < mushroomsPerChunk; j3++)
        {
            ...
            if (randomGenerator.nextInt(8) == 0)
            {
                ...
                int j16 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        if (randomGenerator.nextInt(4) == 0)
        {
            ...
            int k8 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        if (randomGenerator.nextInt(8) == 0)
        {
            ...
            int l8 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int i4 = 0; i4 < reedsPerChunk; i4++)
        {
            ...
            int k16 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int j4 = 0; j4 < 10; j4++)
        {
            ...
            int k13 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        if (randomGenerator.nextInt(32) == 0)
        {
            ...
            int k9 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        for (int l4 = 0; l4 < cactiPerChunk; l4++)
        {
            ...
            int i14 = randomGenerator.nextInt(curWorldObj.worldHeight);
        ...
        if (generateFluid)
        {
            for (int i5 = 0; i5 < 50; i5++)
            {
                ...
                int j14 = randomGenerator.nextInt(randomGenerator.nextInt(curWorldObj.worldHeight - 8) + 8);
            ...
            for (int j5 = 0; j5 < 20; j5++)
            {
                ...
                int k14 = randomGenerator.nextInt(randomGenerator.nextInt(randomGenerator.nextInt(curWorldObj.worldHeight - 16) + 8) + 8);
    ...
    {
        genStandardOre1(20, dirtGen, 0, curWorldObj.worldHeight);
        genStandardOre1(10, gravelGen, 0, curWorldObj.worldHeight);
        genStandardOre1(20, coalGen, 0, curWorldObj.worldHeight);
        genStandardOre1(20, ironGen, 0, curWorldObj.worldHeight / 2);
        genStandardOre1(2, goldGen, 0, curWorldObj.worldHeight / 4);
        genStandardOre1(8, redstoneGen, 0, curWorldObj.worldHeight / 8);
        genStandardOre1(1, diamondGen, 0, curWorldObj.worldHeight / 8);
        genStandardOre2(1, lapisGen, curWorldObj.worldHeight / 8, curWorldObj.worldHeight / 8);
    }
}
