        ...
        if (!world.singleplayerWorld && world.rand.nextInt(4) == 0)
        {
            ...
            else if (k1 >= 2 && k1 <= 5 && (i1 & 1 << i2) == 0)
            {
                ...
                if (k2 == 0 || Block.blocksList[k2] == null)
                {
                    ...
                    else if ((i1 & 1 << i4) != 0 && canBePlacedOn(world.getBlockId(i + Direction.field_35612_a[i2] + Direction.field_35612_a[i4], j, k + Direction.field_35610_b[i2] + Direction.field_35610_b[i4])))
                    {
                        world.setBlockAndMetadataWithNotify(i + Direction.field_35612_a[i2], j, k + Direction.field_35610_b[i2], blockID, 1 << i4);
                    }
                    else if ((i1 & 1 << j3) != 0 && world.isAirBlock(i + Direction.field_35612_a[i2] + Direction.field_35612_a[j3], j, k + Direction.field_35610_b[i2] + Direction.field_35610_b[j3]) && canBePlacedOn(world.getBlockId(i + Direction.field_35612_a[j3], j, k + Direction.field_35610_b[j3])))
                    {
                    ...
                    else if ((i1 & 1 << i4) != 0 && world.isAirBlock(i + Direction.field_35612_a[i2] + Direction.field_35612_a[i4], j, k + Direction.field_35610_b[i2] + Direction.field_35610_b[i4]) && canBePlacedOn(world.getBlockId(i + Direction.field_35612_a[i4], j, k + Direction.field_35610_b[i4])))
                    {
                    ...
                    else if (canBePlacedOn(world.getBlockId(i + Direction.field_35612_a[i2], j + 1, k + Direction.field_35610_b[i2])))
                    {
