...
public class EntitySnowman extends EntityGolem
{
    public EntitySnowman(World par1World)
    {
        ...
        field_48337_aM.addTask(1, new EntityAINearestAttackableTarget(this, net.minecraft.src.EntityMob.class, 16F, 0, true));
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (worldObj.func_48091_a(i, k).func_48442_h() > 1.0F)
        {
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            if (worldObj.getBlockId(l, i1, j1) == 0 && worldObj.func_48091_a(l, j1).func_48442_h() < 0.8F && Block.snow.canPlaceBlockAt(worldObj, l, i1, j1))
            {
