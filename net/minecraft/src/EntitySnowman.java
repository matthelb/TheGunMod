...
public class EntitySnowman extends EntityGolem
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (worldObj.func_48091_a(i, k).getFloatTemperature() > 1.0F)
        {
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            if (worldObj.getBlockId(l, i1, j1) == 0 && worldObj.func_48091_a(l, j1).getFloatTemperature() < 0.8F && Block.snow.canPlaceBlockAt(worldObj, l, i1, j1))
            {
