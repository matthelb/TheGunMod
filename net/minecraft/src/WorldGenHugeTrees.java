    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int l = (par4 + i) - 2 - par2Random.nextInt(4); l > par4 + i / 2; l -= 2 + par2Random.nextInt(4))
        {
            ...
            for (int j3 = 0; j3 < 5; j3++)
            {
                ...
                setBlockAndMetadata(par1World, i2, (l - 3) + j3 / 2, i3, Block.wood.blockID, field_48404_b);
            }
        }
        ...
        for (int j1 = 0; j1 < i; j1++)
        {
            ...
            {
                setBlockAndMetadata(par1World, par3, par4 + j1, par5, Block.wood.blockID, field_48404_b);
            ...
            if (j2 == 0 || j2 == Block.leaves.blockID)
            {
                setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5, Block.wood.blockID, field_48404_b);
            ...
            if (j2 == 0 || j2 == Block.leaves.blockID)
            {
                setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5 + 1, Block.wood.blockID, field_48404_b);
            ...
            setBlockAndMetadata(par1World, par3, par4 + j1, par5 + 1, Block.wood.blockID, field_48404_b);
        ...
        for (int i = par4 - byte0; i <= par4; i++)
        {
            ...
            for (int l = par2 - k; l <= par2 + k + 1; l++)
            {
                ...
                for (int j1 = par3 - k; j1 <= par3 + k + 1; j1++)
                {
                    ...
                    {
                        setBlockAndMetadata(par1World, l, i, j1, Block.leaves.blockID, field_48405_c);
                    }
                }
            }
        }
