...
public class ComponentVillageWoodHut extends ComponentVillage
{
    ...
    public ComponentVillageWoodHut(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        ...
        field_35394_b = par2Random.nextBoolean();
        field_35395_c = par2Random.nextInt(3);
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        if (field_35395_c > 0)
        {
            placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, field_35395_c, 1, 3, par3StructureBoundingBox);
            placeBlockAtCurrentPosition(par1World, Block.pressurePlatePlanks.blockID, 0, field_35395_c, 2, 3, par3StructureBoundingBox);
        }
