...
public class EntityList
{
    ...
    private static void func_46122_a(Class class1, String s, int i, int j, int k)
    {
        addMapping(class1, s, i);
        field_44015_a.put(Integer.valueOf(i), new EntityEggInfo(i, j, k));
    }
    ...
    public static Entity func_44014_a(int i, World world)
    {
        Entity entity = null;
        try
        {
