...
public class RenderSnowball extends Render
{
    ...
    private void func_40265_a(Tessellator tessellator, int i)
    {
        ...
        tessellator.addVertexWithUV(0 - scaleX,  0 - scaleY,  0, f,  f3);
        tessellator.addVertexWithUV(scaleZ - scaleX, 0 - scaleY,  0, f1, f3);
        tessellator.addVertexWithUV(scaleZ - scaleX, scaleZ - scaleY, 0, f1, f2);
        tessellator.addVertexWithUV(0 - scaleX,  scaleZ - scaleY, 0, f,  f2);
        tessellator.draw();
    }
}
