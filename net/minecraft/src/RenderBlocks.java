    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k)
    {
        ...
        for(int i2 = 0; i2 < 4; i2++)
        {
            ...
            if(renderAllFaces || aflag[i2])
            {
                ...
                tessellator.setBrightness(block.getMixedBrightnessForBlock(blockAccess, j2, j, k1));
                float f10 = 1.0F;
                if(i2 < 2)
                {
                    f10 *= f5;
