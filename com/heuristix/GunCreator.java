...
public class GunCreator extends JFrame {
    ...
    private void load(Gun gun) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException, IOException {
        if(gun != null) {
            ...
            Class entityBulletClass = Util.defineClass(gunClasses.get(0).getSecond(), gunClasses.get(0).getFirst());
            Class projectileType = entityBulletClass.getSuperclass();
            if(projectileType.equals(EntityBulletBase.class))
                projectileType = EntityBullet.class;
            ...
            entityBulletClass = Util.defineClass(entityBulletClassBytes, gunClasses.get(0).getFirst());
