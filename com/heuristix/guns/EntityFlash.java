...
public class EntityFlash extends Entity {
    ...
    public EntityFlash(World world, Vec3 position, int brightness, int radius) {
    ...
    public EntityFlash(World world, Vec3 position, int brightness, int radius, int dieRate) {
