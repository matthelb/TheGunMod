...
public abstract class AbstractGunBridge implements GunBridge {
    ...
    static {
        ...
        OBFUSCATED_CLASS_NAMES.add(new Pair("xv", "md"));
        OBFUSCATED_CLASS_NAMES.add(new Pair("xe", "ln"));
        OBFUSCATED_CLASS_NAMES.add(new Pair("up", "jw"));
        OBFUSCATED_CLASS_NAMES.add(new Pair("uo", "jv"));
        OBFUSCATED_CLASS_NAMES.add(new Pair("xd","acq"));
